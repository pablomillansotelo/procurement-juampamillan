...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${PROCUREMENT_API_URL}/v1/suppliers/${params.id}`, {
      headers: {
    ...
    console.error('Error en GET /api/procurement/v1/suppliers/[id]:', error);
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    console.error('Error en PUT /api/procurement/v1/suppliers/[id]:', error);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error en DELETE /api/procurement/v1/suppliers/[id]:', error);
    return NextResponse.json(
